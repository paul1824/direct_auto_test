...
class TestAddAnalysisFieldSettingsTables(BaseTestcase):
    def setUp(self) -> None:
        """获取数据连接列表"""
    ...
    def test_001(self):
        """添加自助数据集"""
        payload = handle_config.analysis_payload['gp_analysis_field_settings']['gp_add_analysis_field_settings_table']
